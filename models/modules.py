...
class DeformConv(nn.Module):
    def  __init__(self,
        ...
        self.deformConv = DeformConv2d(in_channels, out_channels, kernel_size, stride, padding,dilation, groups, bias=False)
...
#     def __init__(self, in_channels, out_channels,
#                  kernel_size=3, stride=1, dilation=1,bias=True,group_channel=8,
#                  norm_act=InPlaceABN):
#         super(ConvgnReLU, self).__init__()
#         self.conv = nn.Conv2d(in_channels,out_channels,
#                               kernel_size=kernel_size,stride=stride,dilation=dilation,padding=((kernel_size-1)//2)*dilation,bias=bias)
#         self.groupNorm = nn.GroupNorm(int(max(1,out_channels/group_channel)),out_channels)
#         self.bn=norm_act(out_channels)
#
#     def forward(self,x):
#         return self.bn(self.conv(x))
#
#
# class deformconvgnrelu(nn.Module):
#     def __init__(self,in_channels,out_channels,
#                  kernel_size=3,stride=1,dilation=1,bias=True,group_channel=8,
#                  norm_act=InPlaceABN):
#         super(deformconvgnrelu, self).__init__()
#
#         self.DCNv2 = DeformConv2d(in_channels,out_channels,kernel_size=kernel_size,stride=stride,bias=bias)
#         self.groupNorm = nn.GroupNorm(int(max(1,out_channels/group_channel)),out_channels)
#         self.bn = norm_act(out_channels)
#
#     def forward(self,x):
#         return self.bn(self.DCNv2(x))
